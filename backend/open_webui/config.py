...
if default_prompt_suggestions == []:
    default_prompt_suggestions = [
        {
            "title": ["讲清一个科学现象", "顺便说说背后的原理"],
            "content": "请选一个生活中常见的科学现象，用适合中小学生理解的方式讲清楚它为什么会发生，并说明背后的核心原理。"
        },
        {
            "title": ["来一道数学思维题", "我想练练真正的思路"],
            "content": "请给我出一道适合中小学生思考的数学题，重点考查分析和思路，不要只是机械计算。先给一点提示，不要立刻公布答案。"
        },
        {
            "title": ["教我一个英语高频表达", "别只背意思，也讲用法"],
            "content": "请教我一个适合中小学生掌握的英语高频表达，告诉我它的意思、常见用法、适用语境和简短例句。"
        },
        {
            "title": ["讲一个重要历史事件", "别只说经过，也讲原因"],
            "content": "请选一个值得中小学生了解的重要历史事件，讲清楚事情经过、发生原因和它带来的影响。"
        },
        {
            "title": ["解释一个地理现象", "让我真正理解为什么"],
            "content": "请选一个常见地理现象，比如季风、降水、气候差异或地形影响，用清楚易懂的方式讲讲为什么会这样。"
        },
        {
            "title": ["讲一个物理原理", "最好联系生活来理解"],
            "content": "请选一个常见物理原理，结合生活中的例子解释它，让我不只记住结论，也真正理解它。"
        },
        {
            "title": ["讲一个生物知识点", "重点说作用和联系"],
            "content": "请选一个中小学生常见的生物知识点，不要只讲定义，重点解释它的作用、特点和容易混淆的地方。"
        },
        {
            "title": ["讲一个化学现象", "看看变化是怎么发生的"],
            "content": "请选一个适合中小学生理解的化学现象，用简单的话讲清楚现象、原因和背后的基本原理。"
        },
        {
            "title": ["讲一个语文知识点", "要清楚，也要好记"],
            "content": "请选一个常见语文知识点，比如修辞、词语辨析、句式特点或阅读方法，用简单清楚的方式讲给我听，并顺便给一个例子。"
        },
        {
            "title": ["来一道逻辑推理题", "看看我能不能发现关键点"],
            "content": "请给我一道适合中小学生的逻辑推理题，重点让我练习找条件、做判断和排除干扰。先别直接公布答案。"
        },
        {
            "title": ["给我一组小练习", "从简单到稍难就好"],
            "content": "请随机选一个常见学习主题，给我出3道从简单到稍难的小练习题，并附上简短提示，先不要直接展开完整答案。"
        },
        {
            "title": ["教我一个记忆方法", "别靠死记硬背"],
            "content": "请教我一种适合中小学生使用的高效记忆方法，可以用来记单词、公式、古诗或知识点，并说明具体怎么操作。"
        },
        {
            "title": ["教我一个作文提分方法", "要能马上用起来"],
            "content": "请教我一个适合中小学生提升作文质量的实用方法，比如开头、结尾、举例、结构或语言表达，并给一个简短示范。"
        },
        {
            "title": ["讲一个科学误区", "告诉我为什么很多人会想错"],
            "content": "请讲一个生活中常见的科学误区，说明它为什么容易让人相信，以及正确的科学解释是什么。"
        },
        {
            "title": ["带我认识一位科学家", "不只讲成就，也讲思路"],
            "content": "请介绍一位适合中小学生了解的科学家，除了他的主要成就，也讲讲他是怎么思考问题和解决问题的。"
        },
        {
            "title": ["讲一个有意思的数学结论", "让我知道它妙在哪里"],
            "content": "请讲一个适合中小学生理解的数学结论或规律，说明它为什么有趣、有什么用，并举一个简单例子。"
        },
        {
            "title": ["学一个英语单词家族", "顺便扩大我的词汇量"],
            "content": "请选一个常见英语核心词，带我认识和它有关的几个词或变化形式，并用简单例句帮助我理解和记忆。"
        },
        {
            "title": ["讲一个阅读理解技巧", "让我读文章更有方法"],
            "content": "请教我一个适合中小学生使用的阅读理解技巧，比如抓主旨、找线索、分析句子或判断作者态度，并给个小示范。"
        },
        {
            "title": ["讲一个生活中的数学", "原来数学真的有用"],
            "content": "请举一个生活中的数学例子，比如购物、时间、路程、面积、概率或统计，讲讲数学在里面是怎么发挥作用的。"
        },
        {
        ...
        {
            "title": ["讲一个历史人物", "看看他为什么值得记住"],
            "content": "请选一位值得中小学生了解的历史人物，讲清楚他做了什么、为什么重要，以及我们能从他身上学到什么。"
        },
        {
            "title": ["解释一个人体知识", "要科学，也别太生硬"],
            "content": "请选一个关于人体的常见知识点，比如大脑、心脏、眼睛、呼吸或骨骼，用自然、准确、容易理解的方式讲给我听。"
        },
        {
            "title": ["来一题应用题", "先给提示再讲思路"],
            "content": "请给我出一道适合中小学生的数学应用题，先给我一点提示，不要直接说答案，等我思考后再讲解。"
        },
        {
            "title": ["教我一个学习方法", "让我效率更高一点"],
            "content": "请教我一个适合中小学生使用的学习方法，比如整理笔记、安排复习、提高专注或检查错题，要求简单、实际、能马上试。"
        },
        {
            "title": ["给我一个科普话题", "要有意思，也要有收获"],
            "content": "请给我一个适合中小学生了解的科普话题，用清楚、生动、不过度幼稚的方式讲一讲，并在最后总结3个关键点。"
        }
    ]
...
USER_PERMISSIONS_WORKSPACE_SKILLS_IMPORT = (
    os.environ.get("USER_PERMISSIONS_WORKSPACE_SKILLS_IMPORT", "False").lower()
    == "true"
)

USER_PERMISSIONS_WORKSPACE_SKILLS_EXPORT = (
    os.environ.get("USER_PERMISSIONS_WORKSPACE_SKILLS_EXPORT", "False").lower()
    == "true"
)
